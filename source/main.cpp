...
string Select_file(const string title)
{
	BROWSEINFO dialog;
	...
	dialog.pszDisplayName = file_name;
...
int main()
{
	...
	while(!app_is_seven_zip_available)
	{
		...
		{
			app_seven_zip_path = Select_file(app_ask_seven_zip_path_msg[app_lang_num]);
	...
	while(!app_is_oscdimg_available)
	{
		...
		{
			app_oscdimg_path = Select_file(app_ask_oscdimg_path_msg[app_lang_num]);
	...
	{
		app_windows10_iso_path = Select_file(app_ask_win10_iso_path_msg[app_lang_num]);
		app_windows11_iso_path = Select_file(app_ask_win11_iso_path_msg[app_lang_num]);

		cout << app_windows10_iso_path[app_lang_num] << app_windows10_iso_path << endl;
		cout << app_windows11_iso_path[app_lang_num] << app_windows11_iso_path << endl << endl;
